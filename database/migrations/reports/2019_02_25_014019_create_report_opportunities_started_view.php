...
class CreateReportOpportunitiesStartedView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        app('db')->statement("create view report_opportunities_started as (
            select
                c.period,
            ...
            from (
                select
                    date(date_format(opportunities.begin_at, '%Y-%m-%d')) as period,
    ...
    {
        app('db')->statement('drop view if exists report_opportunities_started');
    }
}
