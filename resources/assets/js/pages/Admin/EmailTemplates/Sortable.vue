<template lang="html">
  <div class="py-8">
    <sortable-view ref="index" :url="url" title="Categorías">
      ...
      <template slot="actions">
        <router-link :to="{name: 'admin.categories'}" class="btn bg-grey-light uppercase text-grey-dark">Regresar</router-link>
      </template>
    </sortable-view>
  </div>
</template>
